...
// $Rev: 1193 $ $Date: 2012-06-15 17:07:25 -0700 (Fri, 15 Jun 2012) $
//------------------------------------------------------------------------
...
#define OK_PRODUCT_XEM6110LX150             (15)   // NOTE: ASSIGNED OUT OF ORDER
...
typedef struct {
	UINT32             u32SectorCount;
	UINT32             u32SectorSize;
	UINT32             u32PageSize;
	UINT32             u32UserSectorMin;
	UINT32             u32UserSectorMax;
} okTFlashLayout;


typedef struct {
	char            pszDeviceID[OK_MAX_DEVICEID_LENGTH];
	char            pszSerialNumber[OK_MAX_SERIALNUMBER_LENGTH];
	char            pszProductString[OK_MAX_BOARD_MODEL_STRING_LENGTH];
	int             eProduct;
	int             eInterface;
	int             eUSBSpeed;
	int             nDeviceMajorVersion;
	int             nDeviceMinorVersion;
	int             nHostInterfaceMajorVersion;
	int             nHostInterfaceMinorVersion;
	bool            bIsFrontPanelEnabled;
	int             nWireWidth;
	int             nTriggerWidth;
	int             nPipeWidth;
	int             nRegisterAddressWidth;
	int             nRegisterDataWidth;
