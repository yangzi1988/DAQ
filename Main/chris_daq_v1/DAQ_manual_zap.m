%%%% MUST FIX BY CALLING DAQ_updateDAC_script(...)

function DAQ_manual_zap(handles)
...
newzapbiasmV = limit_val(str2double(get(handles.edit_zapmV,'String'))*1e-3, -1, 1);
set(handles.edit_zapmV,'String',newzapbiasmV*1e3);

newbiasmV = limit_val(str2double(get(handles.text_biasvoltage,'String'))*1e-3,-1,1);
...
%DAQ_sendscanvector1(handles.xem, myDACvalues1);
